...
bool CheckIfRightSon(Node* me);
bool CheckIfLeftSon(Node* me);
...
Node* Next(Node* me) {
    ...
    if (me->right!=nullptr){ //need to go down
        Node* next = me->right;
...
bool CheckIfRightSon(Node* me){ return me->parent->right==me;}
bool CheckIfLeftSon(Node* me){ return me->parent->left==me;}
