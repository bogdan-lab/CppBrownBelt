...
public:
  ...
  Booking Book(const BookingData& data) {
    ...
    ++counter;
    //cout << "I booked FLIGHT count --> " << counter << endl;
    return {this, counter};
  }
...
private:
  ...
  void CancelOrComplete(const Booking& booking) {
      --counter;
      //cout << "I called FLIGHT cancel count --> " << counter << endl;
  }
...
public:
  ...
  Booking Book(const BookingData& data) {
    ...
    ++counter;
    //cout << "I booked HOTEL count --> " << counter << endl;
    return {this, counter};
  }
...
private:
  void CancelOrComplete(const Booking& booking) {
    --counter;
      //cout << "I called HOTEL cancel count --> " << counter << endl;
  }
